...
public class HapusActionListener implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (row == -1 || column == -1) {
      ...
      switch (column) {
          case 0 -> // Set col dengan nama
              col = "nama";
          case 1 -> // Set col dengan no_telepon
              col = "no_telepon";
          case 2 -> // Set col dengan jenis_kelamin
              col = "jenis_kelamin";
          case 3 -> // Set col dengan alamat
              col = "alamat";
          default -> // Tampilkan pesan kolom tidak ditemukan
